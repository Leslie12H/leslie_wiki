...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓合并/DEV CI 核验、原生输入准入/终态/安全快照审查、测试导入隔离与发布目录启用；产品准备预留及大快照剩余边界（2026-09-12）
