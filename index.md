...
- [整包提交与重新分批重复范围](domains/sandai-data-smith/refs/sandeval-handoff-duplicate-scope.md) — 当前批次的 key/version 口径、负责人直接分配边界，以及整包交接范围错误和重复报告读取超时的修复与生产核验指针（2026-09-23）。
