...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓合并/DEV CI 与审查核验、完整请求身份、原生文件/普通重启隔离、准备及发布失败/归档预算/处理前取消；产品准备预留与大快照剩余边界（2026-09-12）
