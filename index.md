...
- [监控报告与聊天输出分离](domains/vidmuse/admin/pitfalls/monitoring-report-vs-chat-output.md) — 双协议报告、PR 883/64、脱敏与恢复边界、生产发布与工具同步、发布后 OOM 和严格回放验收指针（2026-09-16）；2026-09-17 补充严格报告接收与真实卡片回调分层验收边界；补缺少 Pod 注解绑定、fresh-evidence 恢复、大文件分段读取与发布后源码脱敏字节边界。
