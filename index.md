...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓草稿、可信运行清单与 Maxwell 比较、容器角色、产品准备预留；无库归属、Zeus outbox 复用及大快照剩余边界（2026-09-12）
