...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓合并/DEV CI 与审查核验、原生入口隔离/准备失败/完整归档预算、测试隔离与发布目录启用；产品准备预留及大快照剩余边界（2026-09-12）
