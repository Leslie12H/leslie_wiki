...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓草稿、可信目录与完整运行清单、Maxwell 比较核验、无库归属及大快照剩余边界；含回执容量和飞书图层实证（2026-09-12）
