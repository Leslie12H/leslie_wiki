...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 普通 Thread 等价性硬要求、AION #1760 / Zeus #525 回退与本地原实现保留；文件/账号迁移、捕获影响及公共 SQL 审核指针（2026-09-14）
