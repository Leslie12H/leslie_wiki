...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓草稿 PR、状态归属、DEV 不可变发布/IAM 门禁、原生续跑与证据等级；尚未部署或完成真实调优（2026-09-12）。
