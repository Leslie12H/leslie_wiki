...
- [VidMuse 无库 Adapter 实施](domains/maxwell/projects/vidmuse-stateless-adapter-implementation.md) — 五仓实现与合并/自动 DEV CI 核验入口、测试导入隔离、发布目录显式启用；无库归属、产品准备预留及大快照剩余边界（2026-09-12）
